...
STRINGS: dict[str, dict[str, str]] = {
    ...
    # ------------------------------------------------------- recognition tab
    "rec.card_model": {
        "ru": "Модель Whisper", "en": "Whisper model", "de": "Whisper-Modell",
        "fr": "Modèle Whisper", "es": "Modelo Whisper", "zh": "Whisper 模型",
        "tr": "Whisper modeli", "hy": "Whisper մոդել",
    },
    "rec.model_hint": {
    ...
    "ob.model_text": {
        "ru": "«small» — хороший баланс скорости и качества для большинства языков.",
        "en": "\"small\" is a good balance of speed and quality for most languages.",
        "de": "„small“ bietet ein gutes Gleichgewicht aus Geschwindigkeit und Qualität für die meisten Sprachen.",
        "fr": "« small » offre un bon équilibre vitesse/qualité pour la plupart des langues.",
        "es": "«small» ofrece un buen equilibrio entre velocidad y calidad para la mayoría de los idiomas.",
        "zh": "「small」在大多数语言中都能较好地兼顾速度与质量。",
        "tr": "\"small\" çoğu dil için hız ve kalite açısından iyi bir denge sunar.",
        "hy": "«small»-ը լավ հավասարակշռություն է ապահովում արագության և որակի միջև գրեթե բոլոր լեզուների համար։",
    },
    "ob.model_tiny": {
    ...
    "ob.model_small": {
        "ru": "small · ~485 МБ · рекомендуется", "en": "small · ~485 MB · recommended", "de": "small · ~485 MB · empfohlen",
        "fr": "small · ~485 Mo · recommandé", "es": "small · ~485 MB · recomendado", "zh": "small · 约485MB · 推荐",
        "tr": "small · ~485 MB · önerilir", "hy": "small · ~485 ՄԲ · խորհուրդ է տրվում",
    },
    "ob.model_medium": {
